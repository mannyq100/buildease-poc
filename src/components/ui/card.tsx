...
const cardVariants = cva(
  "rounded-lg border bg-card text-card-foreground transition-all duration-300",
  {
    variants: {
      ...
      padding: {
        default: "",
        sm: "[&>*:not(:first-child)]:p-2 sm:[&>*:not(:first-child)]:p-3 [&>*:first-child]:p-2 sm:[&>*:first-child]:p-3",
        md: "[&>*:not(:first-child)]:p-3 sm:[&>*:not(:first-child)]:p-4 [&>*:first-child]:p-3 sm:[&>*:first-child]:p-4",
        lg: "[&>*:not(:first-child)]:p-4 sm:[&>*:not(:first-child)]:p-6 [&>*:first-child]:p-4 sm:[&>*:first-child]:p-6",
        xl: "[&>*:not(:first-child)]:p-6 sm:[&>*:not(:first-child)]:p-8 [&>*:first-child]:p-6 sm:[&>*:first-child]:p-8",
        none: "[&>*]:p-0",
      },
      rounded: {
        default: "rounded-lg",
