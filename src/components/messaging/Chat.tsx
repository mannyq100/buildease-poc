  ...
  return (
    <div className={cn("flex h-full", className)}>
      ...
      {(showConversationList || !isMobileView) && (
        <div className={cn(
          "border-r",
          isDarkMode ? "border-slate-700 bg-slate-900" : "border-slate-200",
            ...
            <div className="flex items-center gap-3">
              ...
              {activeConversation.type === "individual" ? (
                ...
                <div className={cn(
                  ...
                  {activeConversation.type === "group" && <Users className="h-4 w-4" />}
                  {activeConversation.type === "project" && <Info className="h-4 w-4" />}
                </div>
              )}
