          ...
          >
            ...
            <div className="relative z-10">
              ...
              >
                ...
                >
                  Transforming construction chaos into seamless project symphonies
                </m.p>
              </m.div>
                ...
                {[
                  {
                    ...
                    description: "Get a complete overview of all your projects in real-time"
                  },
                  {
                    icon: (
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    description: "Track deadlines and milestones with intuitive visual timelines"
                  },
                  {
                    icon: (
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    description: "Seamlessly manage materials, inventory, and project finances"
                  },
                  {
                    icon: (
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            >
              ...
              >
                "The art of construction is rooted in turning vision into reality."
              </m.p>
            </m.div>
          </m.div>
        </AnimatePresence>
          ...
          <div className="w-full max-w-md mx-auto">
            ...
            >
              ...
              <p className="text-slate-600 dark:text-slate-400 mt-2">
                Sign in to continue to your BuildEase dashboard
              </p>
            </m.div>
